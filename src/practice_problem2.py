...
def run_test_practice_problem2a():
    ...
    # Test 1:
    expected = '[6, 9, 14, 10]'
    actual = practice_problem2a([3, 6, 11, 7], 3)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 2:
    expected = '[7, 10, 15, 11]'
    actual = practice_problem2a([3, 6, 11, 7], 4)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = '[13, 16, 21, 17]'
    actual = practice_problem2a([3, 6, 11, 7], 10)
    print('Expected:', expected)
    print('Actual:  ', actual)
