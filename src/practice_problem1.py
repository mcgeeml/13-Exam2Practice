...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.origin = self.contents
        self.origin2 = self.volume
    ...
    def append_string(self, additional_contents):
        ...
        volume = self.volume - len(self.contents)
        self.contents += additional_contents[0:volume]
        return additional_contents[volume:]
    ...
    def double(self):
        ...
        dub = self.append_string(self.contents)
        return dub
    ...
    def shrink(self, new_volume):
        ...
        if new_volume < len(self.contents):
            new_string = self.contents[new_volume:]
    ...
    def double_then_shrink(self, new_volume):
        ...
        dub = self.double()
        temp_str = self.shrink(new_volume)
        return len(temp_str) + len(dub)
    ...
    def reset(self):
        ...
        self.contents = self.origin
        self.volume = self.origin2
